<script >
  ...
  // console.log(JSON.stringify(data.ABOUT_TEAM_IMAGES))

  const json_data = {
    "STATS":[{"value":"42+","label":"Active Members"},{"value":"8","label":"Years Active"},{"value":"20+","label":"Projects Done"},{"value":"10+","label":"Countries Reached"}],
  ...
  function handleAboutTeamEmblaInit(event) {
    console.log('[CAROUSEL DEBUG] Embla initialized');
